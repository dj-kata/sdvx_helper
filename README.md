...
### 選曲画面でその曲のVOLFORCE情報を表示する (v.1.0.7で追加)
...
### VOLFORCE対象曲一覧及び統計情報を表示する (v.1.0.7で追加)
OBSに```out/sdvx_stats.html```をドラッグ&ドロップすると、以下のようなビューを表示できます。  
(推奨サイズ: 幅3000，高さ2200)  
リザルト画面で更新されます。  
![image](https://github.com/dj-kata/sdvx_helper/assets/61326119/a93fc87a-304f-42ad-9431-b4d3f70a79aa)
...
![image](https://github.com/dj-kata/sdvx_helper/assets/61326119/fbad9d54-6afa-4842-8c91-9d56c69a11c4) 

※**曲名認識できる曲のみとなります。現在1000/1500曲程度。**  
認識できない曲 or レベルが登録されていない曲は計算対象外となるため、実際のVFよりも低く出る場合があります。  
こちらは今後のアップデートで改善する予定です。

ソース名がsdvx_stats.htmlである場合のみ、  
